<?php
/**
 * Create new simplified PC parts quotation
 * Path: pcparts/create.php
 */
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($quotation->create()) {
        ...
        $error_message = "Unable to create PC parts quotation.";
    }
}
...
// Page title
$page_title = "Create PC Parts Quotation";
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12">
            <h2>Create PC Parts Quotation</h2>
            ...
            <form method="post" id="pcPartsQuotationForm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="quotation_name" name="quotation_name" required>
                            </div>
                            <div class="col-md-6 mb-3">
                ...
                <div class="d-flex justify-content-between mb-4">
                    ...
                    <button type="submit" id="submit_btn" class="btn btn-success" disabled>Save Quotation</button>
                </div>
            </form>
        </div>
    </div>
...
function addItemToQuotation(itemId, itemName, itemPrice, itemQuantity, itemType) {
    ...
    // Enable submit button if we have at least one item
    document.getElementById('submit_btn').disabled = tableBody.children.length === 0;
